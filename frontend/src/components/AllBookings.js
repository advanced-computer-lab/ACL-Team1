                    ...
                    {/* {editReservationBookingNumber === reservation.bookingNumber ?
                        ...
                        <div id="flight-card" className="card shadow mb-5 bg-white rounded" key={reservation.flightNumber}>
                            ...
                            <div class="card-body">
                                ...
                                <p id="eco-seats"><Icon icon="zmdi:airline-seat-recline-extra" width="25" data-height="25" />&nbsp;Cabin: {reservation.cabin}</p>
                                ...
                                <p id="bus-seats"><Icon icon="el:adult" width="26" height="26"/>&nbsp;Reserved seats for adults: {reservation.adultsSeatsReserved}</p>
